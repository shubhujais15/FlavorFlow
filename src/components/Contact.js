// const Contact = () => {
//     return (
//         <div className="mt-2.5 m-0.5 rounded-xl">
            
//             <section className="text-gray-600 body-font relative flex items-center justify-center h-full" style={{ zIndex: 10 }}>
...
//                                     <a className="text-indigo-500">shubhujais@gmail.com</a>
...
const Contact = () => {
    return (
        <div className="mt-2.5 m-0.5 rounded-xl flex flex-wrap justify-between">
            <div className="lg:w-1/2 md:w-full bg-gray-300 rounded-lg overflow-hidden p-10 relative">
                <iframe 
                    width="100%" 
                    height="800px" 
